...
public class ReservationExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> waitingExceptionHandler(WaitingException waitingException) {
        HttpStatus httpStatus = HttpStatus.valueOf(waitingException.getStatus());
        List<String> messages = List.of(waitingException.getMessage());
        ErrorResponse errorResponse = ErrorResponse.of(httpStatus, messages);
        return ResponseEntity.status(httpStatus).body(errorResponse);
    }
}
